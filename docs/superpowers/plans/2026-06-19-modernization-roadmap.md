...
Event/Aid selection ✅ → Review/Sync ✅ → Cross Check ✅ → Live Entry (next, + Swift reimpl of `APNumberPad`). Each Swift, still using Obj-C network + MagicalRecord via bridging, **verified per-screen** against the live test event.
